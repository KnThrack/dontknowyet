			...
			<div key={myRecipe._id.toString()} className='container'>
				<Form id='bigform' /*controlId={recipe._id.toString()+".Form"}*/>
					...
					<Form.Group /*controlId={recipe._id.toString()+".ControlTextarea1"}*/>
						<JoditEditor editorRef={this.setRef} value={myRecipe.recipe} config={this.config} onChange={this.handleJoditInputChange} />
					...
					<ButtonToolbar>
						...
						<Button type='button' variant='primary' onClick={this.handleAddIngredient}>
							Add Ingredient
						</Button>
					</ButtonToolbar>
				</Form>
